...
namespace App\Http\Livewire\Jumpers\K11483;
...
class K11483Index extends Component
{
    use WithPagination;
    ...
    public function mount(){
     ...
     public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=11483')
                ->where('user_id',$this->user->id)
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k11483.k11483-index','verific');
    }
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k11483/1/'.$this->psid_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=11483';
                    ...
                    if($this->busqueda_link){
                        ...
                        if($url_detect_com != false){
                            ...
                            $link->jumper_type_id = 43;
                            $link->k_detected = 'K=11483';
                            $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k11483_ = strpos($this->search, 'k=11483&');

            if($busqueda_k11483_ !== false){
        ...
        return view('livewire.jumpers.k11483.k11483-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k11483.k11483-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k11483.index');
    }
}
