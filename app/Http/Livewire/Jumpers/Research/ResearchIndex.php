...
namespace App\Http\Livewire\Jumpers\Research;
...
class ResearchIndex extends Component
{
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.research.research-index','render');
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.research.research-index',compact('jumpers'));
    }
