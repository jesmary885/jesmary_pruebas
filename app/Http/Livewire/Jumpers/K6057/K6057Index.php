...
namespace App\Http\Livewire\Jumpers\K6057;
...
class K6057Index extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k6057.k6057-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=6057')
                ->where('user_id',$this->user->id)
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k6057/1/'.$this->psid_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=6057';
                    ...
                    $link_register->save();
                                        ...
                                        if($this->busqueda_link){
                                            ...
                                            if($url_detect_com != false){
                                                ...
                                                $link->jumper_type_id = 28;
                                                $link->k_detected = 'K=6057';
                                                $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k6057_ = strpos($this->search, 'k=6057&');

            if($busqueda_k6057_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k6057.k6057-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k6057.index');
