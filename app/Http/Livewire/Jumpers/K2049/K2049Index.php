...
namespace App\Http\Livewire\Jumpers\K2049;
...
class K2049Index extends Component
{
    use WithPagination;
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=2049')
                ->where('user_id',$this->user->id)
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k2049.k2049-index','verific');
    }
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k2049/1/'.$this->psid_buscar);
                    ...
                    if($this->busqueda_link){
                        ...
                        $comments = Comments::where('link_id',$this->busqueda_link->id)
                            ...
                            if($url_detect_com != false){
                                ...
                                $link->jumper_type_id = 31;
                                $link->k_detected = 'K=2049';
                                $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k2049_ = strpos($this->search, 'k=2049&');

            if($busqueda_k2049_ !== false){
                ...
                if($this->jumper_detect == 0 && $this->psid_buscar != 'vacio'){
                        ...
                        if($this->jumper_list == 0){
                            ...
                            if($link_register_search >= 1){
                                ...
                                $links_usados = Links_usados::where('k_detected','K=1091')
                                    ->where('user_id',$this->user->id)
                                    ->whereBetween('created_at',[$date_actual_30,$date_actual])
                                    ->count();
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k2049.k2049-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k2049.k2049-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k2049.index');
    }
}
