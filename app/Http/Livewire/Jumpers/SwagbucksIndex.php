...
class SwagbucksIndex extends Component
{
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/Saltador_swagbucks/1/'.$token_1.'/'.$token_2 );
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.swagbucks-index');
    }
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('swagbucks.index');
