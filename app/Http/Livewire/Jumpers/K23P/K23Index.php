            ...
            try {
                ...
                $client = new Client([
                    ...
                    if($elem3 == 0){
                         ...
                         $resultado = $client->request('GET', '/k23_s2_k2_imperium/1/'.$ids_buscar.'/'.$this->psid_buscar.'/'.$k2_buscar.'/'.$chanel_buscar.'/'.$pid_buscar_def.'/'.$elem1.'/'.$elem2);
                        
                     
                    }
                    else{
                        $resultado = $client->request('GET', '/k23_s2_k2_imperium/1/'.$ids_buscar.'/'.$this->psid_buscar.'/'.$k2_buscar.'/'.$chanel_buscar.'/'.$pid_buscar_def.'/'.$elem1.'/'.$elem2.'/'.$elem3);
