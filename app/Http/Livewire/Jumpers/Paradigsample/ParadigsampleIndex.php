...
class ParadigsampleIndex extends Component
{
     use WithPagination;
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('paradigsample.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.paradigsample.paradigsample-index',compact('jumpers'));
    }
}
