...
namespace App\Http\Livewire\Jumpers\K3906;
...
class K3906Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k3906.k3906-index','verific');
    }
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                if($resultado->getStatusCode() == 200){
                                        ...
                                        $link_register->k_detected  = 'K=3906';
                                        ...
                                        if($this->busqueda_link){
                                            ...
                                            if($url_detect_com != false){
                                                ...
                                                $link->jumper_type_id = 18;
                                                $link->k_detected = 'K=3906';
                                                $link->save();
    ...
    public function render()
    {
        ...
        if($long_psid>=5){
            ...
            $busqueda_k3906_ = strpos($this->search, 'k=3906&');

            if($busqueda_k3906_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k3906.k3906-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k3906.k3906-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k3906.index');
