...
namespace App\Http\Livewire\Jumpers\K5541;
...
class K5541Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k5541.k5541-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=5541')
                ->where('user_id',$this->user->id)
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k5541/1/'.$this->psid_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=5541';
                    ...
                    if($this->busqueda_link){
                        ...
                        if($url_detect_com != false){
                            ...
                            $link->jumper_type_id = 45;
                            $link->k_detected = 'K=5541';
                            $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k5541_ = strpos($this->search, 'k=5541&');

            if($busqueda_k5541_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k5541.k5541-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k5541.k5541-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k5541.index');
    }
}
