...
class K1050Index extends Component
{
    ...
    public function jumpear(){
        ...
        if($this->jumper_detect == 0){
            ...
            if($link_register_search >= 1){
                ...
                $links_usados = Links_usados::where('k_detected','K=1050')
                    ->where('user_id',$this->user->id)
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k1050-index','verific');
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            if($hash){
                ...
                $resultado = $client->request('GET', '/k1050/1/'.$this->psid_buscar.'/'.$pid_buscar_def.'/'.$hash->hash);
                    ...
                    if($resultado->getStatusCode() == 200){
                        ...
                        $link_register->k_detected  = 'K=1050';
                        ...
                        if($this->busqueda_link){
                            ...
                            if($url_detect_com != false){
                                ...
                                $link->jumper_type_id = 61;
                                $link->k_detected = 'K=1050';
                                $link->save();
    ...
    public function render()
    {
       ...
       // $this->jumper_detect = 0;
        ...
        return view('livewire.jumpers.k1050-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function confirmacion(){
        ...
        $jumpers = Links_usados::where('k_detected','K=1050')
            ->where('user_id',$this->user->id)
            ->whereDate('created_at',$date_actual)
            ->take('5')
            ->delete();
        ...
        $this->emitTo('jumpers.k1050-index','render');
    }
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('kmil_cincuenta.index');
