...
namespace App\Http\Livewire\Jumpers\Invite;
...
class InviteIndex extends Component
{
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.invite.invite-index','render');
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.invite.invite-index',compact('jumpers'));
    }
