...
namespace App\Http\Livewire\Jumpers\K10125;
...
class K10125Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k10125.k10125-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=10125')
                ->where('user_id',$this->user->id)
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k10125/1/'.$this->psid_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=10125';
                    ...
                    if($this->busqueda_link){
                        ...
                        if($url_detect_com != false){
                            ...
                            $link->jumper_type_id = 40;
                            $link->k_detected = 'K=10125';
                            $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k10125_ = strpos($this->search, 'k=10125&');

            if($busqueda_k10125_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k10125.k10125-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k10125.k10125-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k10125.index');
    }
}
