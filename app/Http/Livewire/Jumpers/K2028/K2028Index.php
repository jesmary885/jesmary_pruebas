...
namespace App\Http\Livewire\Jumpers\K2028;
...
class K2028Index extends Component
{
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=2028')
                ->where('user_id',$this->user->id)
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    if($this->busqueda_link){
                                            ...
                                            if($url_detect_com != false){
                                                ...
                                                $link->jumper_type_id = 29;
                                                $link->k_detected = 'K=2028';
                                                $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k2028_ = strpos($this->search, 'k=2028&');

            if($busqueda_k2028_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k2028.k2028-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k2028.k2028-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k2028.index');
