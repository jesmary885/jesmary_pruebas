...
class ProdegeCreate extends Component
{
    ...
    {
        return view('livewire.jumpers.prodege.prodege-create');
    }
    ...
    public function save(){
        ...
        $this->emitTo('jumpers.prodege.prodege-index','render');
    }
}
