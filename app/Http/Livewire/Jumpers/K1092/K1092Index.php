...
namespace App\Http\Livewire\Jumpers\K1092;
...
class K1092Index extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k1092.k1092-index','verific');
    }
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=1092';
                        ...
                        $comments = Comments::where('link_id',$this->busqueda_link->id)
                            ...
                            $this->points_user_negative='no';
                                        ...
                                        if($url_detect_com != false){
                                            ...
                                            $link->jumper_type_id = 6;
                                            $link->k_detected = 'K=1092';
                                            $link->save();
                ...
                if($this->jumper_detect == 0 && $this->psid_buscar != 'vacio'){
                        ...
                        if($this->jumper_list == 0){
                            ...
                            if($link_register_search >= 1){
                                ...
                                $links_usados = Links_usados::where('k_detected','K=1092')
                                    ->where('user_id',$this->user->id)
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k1092.k1092-index','render');
    }
