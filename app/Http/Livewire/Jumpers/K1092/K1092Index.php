            ...
            if($busqueda_k1092_ !== false){
                ...
                if($busqueda_ast_ !== false){
                    ...
                    if($busqueda_hash !== false){
                            ...
                            do{
                                $detect_h= substr($this->search, $posicion_hash,1);
                            ...
                            $hash_buscar = substr($this->search,($busqueda_hash + 4),($posicion_hash - ($busqueda_hash + 4)));
                            ...
                            if($this->jumper_list == 0){
                                ...
                                $resultado = $client->request('GET', '/k1092/1/'.$psid_buscar.'/'.$hash_buscar);
                ...
                if($this->busqueda_link){
                    ...
                    if($busqueda_k1000_ == false && $busqueda_k2062_ == false && $busqueda_k3203_ == false && $busqueda_k7341_ == false ){
