...
namespace App\Http\Livewire\Jumpers\Samplicity;
...
class SamplicityIndex extends Component
{
    use WithPagination;
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.samplicity.samplicity-index','render');
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('samplicity.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.samplicity.samplicity-index',compact('jumpers'));
    }
