...
class K1083IndexV3 extends Component
{
   ...
   protected $listeners = ['render' => 'render', 'registro_psid' => 'registro_psid' , 'verific' => 'verific', 'confirmacion' => 'confirmacion'];
    ...
    public function numerologia(){
        ...
        $operacion_total = 'Resuelve esta operación matemática ('.$this->operacion->nro1.' + '.$this->operacion->nro2. ')';
          ...
          $this->emit('numerologia',$operacion_total,'jumpers.k1083.k1083-index-v3','verific');
    }
        ...
        if($result[0] == $this->operacion->resultado){
          ...
          /* $posicion_set = $posicion_serie + 1;
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k1083_imperium_v3/1/'.$serie_buscar.'/'.$this->psid_buscar);
    ...
    public function render()
    {
       ...
       // $this->jumper_detect = 0;
        ...
        return view('livewire.jumpers.k1083.k1083-index-v3',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
        ...
        if($this->total_jump_dia == 10) {
            if($this->user->balance >= 1) {
                if($this->recargas_user_dia <= 1){
                    $this->emit('canjear', '¿Esta seguro de realizar el canje?','jumpers.k1083.k1083-index-v3','confirmacion','El caje se ha realizado');
                }
            }
        }
    }
    ...
    public function confirmacion(){
        ...
        $this->emitTo('jumpers.k1083.k1083-index-v3','render');
    }
