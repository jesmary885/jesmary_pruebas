...
namespace App\Http\Livewire\Jumpers\K2027;
...
class K2027Index extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k2027.k2027-index','verific');
    }
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $client = new Client();
                 ...
                 $resultado = $client->post('http://67.205.168.133/knavigator/1/', [
                    ...
                    if($this->jumper_complete)
                    {
                        ...
                        if($this->busqueda_link){
                            ...
                            if($url_detect_com != false){
                                ...
                                $link->jumper_type_id = 59;
                                $link->k_detected = 'K=2027';
                                $link->save();
    ...
    public function render()
    {
                        ...
                        if($this->jumper_detect == 0){
                            ...
                            if($this->jumper_list == 0){
                                ...
                                if($link_register_search >= 1){
                                    ...
                                    $links_usados = Links_usados::where('k_detected','K=2027')
                                        ->where('user_id',$this->user->id)
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k2027.k2027-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
     ...
     public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k2027.k2027-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k2027.index');
    }
}
