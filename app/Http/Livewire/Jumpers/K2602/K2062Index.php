...
namespace App\Http\Livewire\Jumpers\K2602;
...
class K2062Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k2602.k2062-index','verific');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.k2602.k2062-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k2602.k2062-index','render');
