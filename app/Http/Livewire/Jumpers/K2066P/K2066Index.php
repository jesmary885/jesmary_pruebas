...
namespace App\Http\Livewire\Jumpers\K2066P;
...
class K2066Index extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k2066-p.k2066-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=2066_NEW')
                ->where('user_id',$this->user->id)
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            if($busqueda_morpace != false){

                $posicion_serie = $busqueda_morpace + 12;
                $i_serie = 0;
                $busq_serie_s = 0;
                ...
                do{
                    ...
                    if($detect_serie == '?' || $detect_serie == '&') $i_serie = 1;
                    else{
                ...
                $serie_buscar = substr($this->search,($busqueda_morpace + 12),($posicion_serie - ($busqueda_morpace + 12)));
                ...
                if($busqueda_p != false){
                    ...
                    $serie_buscar = substr($this->search,($busqueda_p + 3),($posicion_serie - ($busqueda_p + 3)));
                }
                else{

                    if($busqueda_project != false){

                        $posicion_serie = $busqueda_project + 10;
                        $i_serie = 0;
                        $busq_serie_s = 0;
                        ...
                        $serie_buscar = substr($this->search,($busqueda_project + 10),($posicion_serie - ($busqueda_project + 10)));
                    }
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k2066/2/'.$this->psid_buscar.'/'.$serie_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=2066_NEW';
    ...
    public function render()
    {
                                ...
                                $busqueda_link_def =  $this->busqueda_link;
                                    ...
                                    if($this->busqueda_link){
                                         ...
                                         if($url_detect_com != false){
                                             ...
                                             $link->psid = substr($this->psid_buscar,0,5);
                                             $link->user_id = auth()->user()->id;
                                             $link->jumper_type_id = 44;
                                             $link->k_detected = 'K=2066_NEW';
                                             $link->save();
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k2066-p.k2066-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k2066-p.k2066-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k2066_poderosa.index');
    }
}
