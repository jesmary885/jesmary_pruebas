...
namespace App\Http\Livewire\Jumpers\Bitlab;
...
class BitlabIndex extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.bitlab.bitlab-index','verific');
    }
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/Saltador_bitlab/1/'.$token_1.'/'.$token_2 );
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.bitlab.bitlab-index');
    }
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('bitlab.index');
