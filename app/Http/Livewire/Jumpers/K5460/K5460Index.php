...
namespace App\Http\Livewire\Jumpers\K5460;
...
class K5460Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k5460.k5460-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=5460')
                ->where('user_id',$this->user->id)
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=5460';
                    ...
                    $link_register->save();
                                        ...
                                        if($this->busqueda_link){
                                            ...
                                            if($url_detect_com != false){
                                                ...
                                                $link->jumper_type_id = 27;
                                                $link->k_detected = 'K=5460';
                                                $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k5460_ = strpos($this->search, 'k=5460&');

            if($busqueda_k5460_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k5460.k5460-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k5460.k5460-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k5460.index');
