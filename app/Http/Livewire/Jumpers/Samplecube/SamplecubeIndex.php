...
class SamplecubeIndex extends Component
{
    use WithPagination;
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('samplecube.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.samplecube.samplecube-index',compact('jumpers'));
    }
