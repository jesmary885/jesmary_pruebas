...
class K3203Index extends Component
{
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=3203')
                ->where('user_id',$this->user->id)
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k3203.k3203-index','verific');
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k3203.k3203-index','render');
