...
class SamplicioBz extends Component
{
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.samplicio.samplicio-bz','verific');
    }
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/Sampliciobz/1/'.$ssid_buscar);
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.samplicio.samplicio-bz');
    }
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('samplicio_bz.index');
    }
}
