...
class SamplicioJumperCom extends Component
{
    use WithPagination;
    ...
    public function comentar(){
        ...
        $this->emitTo('jumpers.samplicio.samplicio-jumper-com','render');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.samplicio.samplicio-jumper-com',compact('comments'));
    }
