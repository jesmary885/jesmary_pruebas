...
class SurveyDash extends Component
{
    use WithPagination;
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.survey-dash.survey-dash','render');
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('survey_dashmr.index');
    }
    ...
    public function render()
    {
        ...
        return view('livewire.jumpers.survey-dash.survey-dash',compact('jumpers'));
    }
}
