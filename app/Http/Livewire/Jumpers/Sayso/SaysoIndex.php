...
namespace App\Http\Livewire\Jumpers\Sayso;
...
class SaysoIndex extends Component
{
    use WithPagination;
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.sayso.sayso-index','render');
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('sayso.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.sayso.sayso-index',compact('jumpers'));
    }
