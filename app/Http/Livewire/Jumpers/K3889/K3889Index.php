...
namespace App\Http\Livewire\Jumpers\K3889;
...
class K3889Index extends Component
{
    use WithPagination;
    ...
    public function numerologia(){
        ...
        $this->emit('numerologia',$operacion_total,'jumpers.k3889.k3889-index','verific');
    }
    ...
    public function jumpear(){
        ...
        if($link_register_search >= 1){
            ...
            $links_usados = Links_usados::where('k_detected','K=3889')
                ->where('user_id',$this->user->id)
    ...
    public function verific($result){
        ...
        if($result[0] == $this->operacion->resultado){
            ...
            try {
                ...
                $resultado = $client->request('GET', '/k3889/1/'.$this->psid_buscar);
                ...
                if($resultado->getStatusCode() == 200){
                    ...
                    $link_register->k_detected  = 'K=3889';
                    ...
                    if($this->busqueda_link){
                        ...
                        if($url_detect_com != false){
                            ...
                            $link->jumper_type_id = 42;
                            $link->k_detected = 'K=3889';
                            $link->save();
    ...
    public function render()
    {
       ...
       // $this->busqueda_link = "";
        ...
        if($long_psid>=5){
            ...
            $busqueda_k3889_ = strpos($this->search, 'k=3889&');

            if($busqueda_k3889_ !== false){
       ...
       // session()->forget('search');
        ...
        return view('livewire.jumpers.k3889.k3889-index',compact('jumper','comments','subs_psid','busqueda_link_def'));
    }
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.k3889.k3889-index','render');
    ...
    public function clear(){
        ...
        session()->forget('search');
        $this->busqueda_link = "";
        return redirect()->route('k3889.index');
    }
}
