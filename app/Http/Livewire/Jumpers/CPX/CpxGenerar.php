...
class CpxGenerar extends Component
{
    ...
    public function procesar(){
        ...
        try {
            ...
            $client = new Client();
                ...
                $resultado = $client->post('http://146.190.74.228/cpx_iniciador_freecash/1/', [
            ...
            if($resultado->getStatusCode() == 200){
                ...
                $links_usados = Links_usados::where('k_detected','CPX-GENERAR')
                ...
                if($links_usados <= 5){
                    ...
                    $link_register->k_detected  = 'CPX-GENERAR';
    ...
    {
        return view('livewire.jumpers.c-p-x.cpx-generar');
    }
}
