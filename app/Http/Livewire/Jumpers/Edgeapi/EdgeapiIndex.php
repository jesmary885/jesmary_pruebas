...
namespace App\Http\Livewire\Jumpers\Edgeapi;
...
class EdgeapiIndex extends Component
{
      use WithPagination;
    ...
    public function positivo($jumper_id){
        ...
        $this->emitTo('jumpers.edgeapi.edgeapi-index','render');
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('edgeapi.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.edgeapi.edgeapi-index',compact('jumpers'));
    }
