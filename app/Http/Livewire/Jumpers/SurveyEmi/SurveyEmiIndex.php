...
namespace App\Http\Livewire\Jumpers\SurveyEmi;
...
class SurveyEmiIndex extends Component
{
    use WithPagination;
    ...
    public function clear(){
        ...
        $this->busqueda_link = "";
        return redirect()->route('survey_emirs.index');
    }
     ...
     public function render()
    {
        ...
        return view('livewire.jumpers.survey-emi.survey-emi-index',compact('jumpers'));
    }
