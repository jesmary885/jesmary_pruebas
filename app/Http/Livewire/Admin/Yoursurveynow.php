...
class Yoursurveynow extends Component
{
    ...
    public function mount(){
        ...
        elseif($this->user->id == '268' || $this->user->id == '584' || $this->user->id == '746' || $this->user->id == '1901' || $this->user->id == '112' || $this->user->id == '14' || $this->user->id == '92') $this->limit = 19; //TRABAJADORES Y JHON
    ...
    public function render()
    {
        ...
        $this->total_jump_dia = Links_usados::where('k_detected','K=1000_YSN')
            ->where('user_id',$this->user->id)
            ->whereDate('created_at',$date_actual)
            ->count();
