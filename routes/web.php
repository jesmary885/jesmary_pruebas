...
Route::get('/test-pva-auth', function() {
    ...
    return response()->json($results);
      ...
      //  Route::get('generador_p_vo',[JumpersController::class,'generador_new_vo'])->name('generador_vo.index')->middleware('permission:menu.premium');
        ...
        Route::get('Registro_cuentas',[JumpersController::class,'registro_cuentas'])->name('registro.cuentas')->middleware('permission:administracion_principal');
        Route::get('Verificacion_cuentas',[JumpersController::class,'verificacion_cuentas'])->name('verificacion.cuentas')->middleware('permission:administracion_principal');
