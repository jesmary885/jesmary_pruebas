    ...
    <div class="card">
            ...
            <div class="grid md:grid-cols-4 gap-2">
                    ...
                    <div class="col-span-3">
                        ...
                        <div class="w-full mt-2">
                            <input wire:model.defer="ext_user_id" placeholder="ExtId"  class="form-control w-1/2" >
                        </div>

                        <div class="w-full mt-2">
                            <input wire:model.defer="survey_id" placeholder="SurveyId"  class="form-control w-1/2" >
                        </div>
                        ...
                        <div class="w-1/2 mt-2">
                                ...
                                <select wire:model="opcion" class="form-control w-full">
        ...
        @if($jumper_complete)
            <div class="flex-nowrap justify-center callout callout-info w-full">
                ...
                <p  class="text-blue-400 text-clip text-sm text-center font-bold mb-2" id="jumper_copy">{{$jumper_complete['link']}}</p>
