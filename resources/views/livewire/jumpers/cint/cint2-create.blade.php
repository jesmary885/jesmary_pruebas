                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model="panel" class="form-control" id="formGroupExampleInput" placeholder="https://s.cint.com/survey/fingerprint/xxxxxxxxxxxxxxxxxxxxxxxx">
                            <x-input-error for="panel" />
                        </div>
                        <div class="form-group">
                            <label for="formGroupExampleInput2">Jumper</label>
                            <input type="text" wire:model="jumper" class="form-control" id="formGroupExampleInput2" placeholder="https://s.cint.com/Survey/Complete?ProjectToken=xxxxxxxxxxxxxxxxxxxxxxxxxxx">
