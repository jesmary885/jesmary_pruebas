                            ...
                            <tbody>
                                @foreach ($jumper_complete as $registro)
                                    <tr class="bg-gray-800 border-gray-700 hover:bg-gray-600">
                                        ...
                                        <td class="text-center">{{$registro['lengthMinutes']}}</td>
                                        <td class="text-center">{{$registro['localizedReward']}}</td>

                                    
                                        <td><p  class="text-blue-400 text-clip text-sm font-bold mb-2" id="jumper_copy_{{ $loop->index }}">{{$registro['url']}}</p></td>
