        ...
        @endif
            ...
            <div class="card-body mt-0">
                ...
                <div class="flex-nowrap justify-center callout callout-info">
                    ...
                    <p  class="text-blue-400 text-clip text-sm text-center font-bold mb-2 w-full" id="jumper_copy">{{$jumper_complete['jumper']}}</p>
                ...
                @if($busqueda_link || $jumper_complete || $psid_buscar == 'vacio' && $jumper_detect == 0)
