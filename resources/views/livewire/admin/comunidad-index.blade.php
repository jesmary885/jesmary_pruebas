<div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$users_activos}}</h3>
                    <p class="sm:text-xs md:text-md font-bold">ACTIVOS</p>
                </div>
                <div class="icon">
        ...
        <div class="small-box bg-info">
                <div class="inner">
                    ...
                    <p class="sm:text-xs md:text-md font-bold">ESTATUS INACTIVO (NO INGRESA)</p>
                </div>
                <div class="icon">
                    <i class="fas fa-users"></i>
                </div>
        ...
        <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$users_inactivos_rol}}</h3>
                    <p class="sm:text-xs md:text-md font-bold">ROL INACTIVO (NO RENOVÓ)</p>
                </div>
                <div class="icon">
                    <i class="fas fa-users"></i>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$users_plan_10_premium}}</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN 10 DÍAS</p>
                </div>
                <div class="icon">
                    <i class="fas fa-money-bill-wave"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3>{{$users_plan_2_premium}}</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN 2 DÍAS</p>
                </div>
                <div class="icon">
                    <i class="fas fa-money-bill-wave"></i>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    ...
                    <p class="sm:text-xs md:text-md font-bold">PLAN BÁSICO</p>
                </div>
                <div class="icon">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_dia_10_premium}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN 10 DÍAS - PREMIUM</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_dia_2_premium}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN 2 DÍAS - PREMIUM</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_dia_5_premium}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">RESTANTE PLAN PREMIUM</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_dia_saldo_pagina}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">SALDOS EN PÁGINA</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
    ...
    <h2 class="text-gray-200 font-bold p-2 text-lg mb-4">
        GANANCIAS POR FECHA - Ingrese el rango de fechas en que desee consultar las ganancias
    </h2>
    ...
    <div class="lg:flex justify-items-stretch ">
        ...
        <button type="button" class="btn btn-primary ml-2" wire:click="buscar">Buscar</button>
    </div>
   ...
   @if($carga_total == 1)
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    ...
                    <p class="sm:text-xs md:text-md font-bold">PLAN PREMIUM 30 DÍAS</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_mes_10_premium}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN PREMIUM 10 DÍAS</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_mes_2_premium}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">PLAN PREMIUM 2 DÍAS</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-6">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$ganancia_mes_premium_suscriptor_total}} $</h3>
                    <p class="sm:text-xs md:text-md font-bold">TOTAL</p>
                </div>
                <div class="icon">
                    <i class="fas fa-hand-holding-heart"></i>
