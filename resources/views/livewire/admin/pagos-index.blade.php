            ...
            <div class="card card-secondary card-outline">
                ...
                <div class="card-body">
                    <div class="md:flex items-center justify-between">
                        ...
                        <div class="w-full md:w-1/5 md:ml-4 ml-2">

                            <label class="text-gray-200 text-md md:text-md">Filtro del buscador</label>
                        ...
                        <div class="md:flex-1 md:ml-4 sm:mt-2 md:mt-0">
                            <label class="text-gray-200 text-md ">Buscador</label>
                            @if($buscador != 2)
                                <input wire:model="search" placeholder="Ingrese username o Nro de referencia" class="form-control">
                            @else
