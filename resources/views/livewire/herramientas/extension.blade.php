        ...
        <div class="card-header">
            <div>
                ...
                <div class="w-1/3 mt-2" >
                    ...
                    <input wire:model.defer="numero" placeholder="Introduzca el número" id="validationCustomUsername" class="form-control" aria-describedby="inputGroupPrepend" >
                ...
                <div class=" info-box bg-warning">
                    <span class="info-box-icon"><i class="far fa-sad-tear"></i></span>
                        <div class="info-box-content">
                            ...
                            <span class="info-box-number">Ha ocurrido un error al generar la extension...</span>
                        </div>
                </div>
            ...
            <div class="px-4">
                <div class=" info-box bg-warning">
                    <span class="info-box-icon"><i class="fas fa-tag"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Algo en su numero no esta bien. </span>
        ...
        @if ($jumper_detect == 8)
            <div class="px-4">
                <div class=" info-box bg-warning">
                    <span class="info-box-icon"><i class="fas fa-tag"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">Ya ha procesado las 5 extensiones permitidas en el día </span>
           ...
           @if ($jumper_complete)
                ...
                <div class="card-body mt-0">
                        ...
                        <div class="flex-nowrap justify-center callout callout-info w-full">
                                ...
                                <p  class="text-blue-400 text-clip text-sm text-center font-bold mb-2" id="jumper_copy">{{$jumper_complete['key']}}</p>
