<div>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <div>
                <button type="submit" class="btn bg-info " wire:click="procesar_ctx">
                    PROCESAR CTX
                </button>
            </div>
        </div>
        ...
        @if ($jumper_ctx)
                ...
                <div class="flex-nowrap justify-center callout callout-info w-full">
                    ...
                    <p  class="text-blue-400 text-clip text-sm text-center font-bold mb-2" id="jumper_copy">{{$jumper_ctx['jumper']}}</p>
