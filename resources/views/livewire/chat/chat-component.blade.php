        ...
        <div class="grid grid-cols-3 divide-x divide-gray-200 w-full">
            <div class="col-span-1">
                ...
                <div class="bg-white h-14 flex items-center px-4">
                    <x-jet-input
                    wire:model="search" type="text" class="w-full" placeholder="Busque un chat o inicie uno nuevo">

                    </x-jet-input>
                </div>

                <div class="overflow-auto h-[calc(88vh-10.5rem)] border-t border-gray-200">
            ...
            <div class="col-span-2">
                ...
                <form class="bg-gray-100 h-16 flex items-center px-4" wire:submit.prevent="sendMessage()">
                    <x-jet-input wire:model="bodyMessage" type="text" class="flex-1 text-gray-700" placeholder="Escriba un mensaje aquí">
