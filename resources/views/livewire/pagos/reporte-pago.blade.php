                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        @if($user_page->type == 'premium 30' || $user_page->type == 'premium 10' || $user_page->type == 'premium 2' )
                            ...
                            <p class="info-box-text"> - Plan Premium (30 días) 25$ </p>
                            <p class="info-box-text"> - {{25* $tasa_dia_dolar}} Bs. </p>
                            <p class="info-box-text"> - {{round((25 / $tasa_dia_ltc),2)}} LTC.</p>
