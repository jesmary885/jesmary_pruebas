        ...
        <div class="col-12 col-sm-12 col-md-6">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">Jumpers generados</span>
                    <span class="info-box-number text-lg">{{$total_jump_dia}}</span>
                </div>

                <div class="mt-4">
                    @if ($jumper_complete)
                        @livewire('ktmr.cargar-datos', ['inicial' => $search])
                    @endif
                </div>
            </div>
        </div>
        ...
        @if ($jumper_detect == 10)
            <div class="px-4">
                <div class=" info-box bg-warning">
                    <span class="info-box-icon"><i class="far fa-sad-tear"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text">¡No puedes jumpear!</span>
                            <span class="info-box-number">Tienes alguna(s) cuenta(s) sin registrar correo y contraseña</span>
                        </div>
                </div>
